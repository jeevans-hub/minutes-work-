  ...
  const handleSubmit = async (e) => {
    ...
    if (result.success) {
      ...
      if (role !== 'customer' && role !== 'admin') {
        // Technically a worker could try to login here, 
        // we might want to allow it but redirect them to their dashboard
        // or strictly say "Use worker login".
        // For now, let's redirect based on role but label the page clearly.
      }
    ...
    <div className="min-h-screen flex items-center justify-center px-4 pt-16">
      ...
      <div className="w-full max-w-md glass-card p-8 animate-fade-in">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 text-sm mt-1">Sign in to book skilled workers</p>
        </div>
        ...
        <p className="text-center text-slate-400 text-sm mt-2">
          ...
          <Link href="/register/customer" className="text-indigo-400 hover:text-indigo-300 font-medium">
            Register here
          </Link>
        </p>
